...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		aplhabetkey();
		document.getElementById("d1").innerHTML="pesianaste una letra";
		console.log("letra");
		}

	else	if((keyPressed >=48 && keyPressed<=57)){
			numberkey();
			document.getElementById("d1").innerHTML="pesianaste una numero";
			console.log("numero");
			}

			else	if((keyPressed >=37 && keyPressed<=40)){
				arrowkey();
				document.getElementById("d1").innerHTML="pesianaste una flecha";
				console.log("flecha");
				}
		...
		otherkey();
		document.getElementById("d1").innerHTML="presionaste un caracter especial";
	}
}
